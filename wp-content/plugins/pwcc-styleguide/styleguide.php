...
<html id="patternlab-html">
	<head id="patternlab-head">
		...
		<link rel="stylesheet" href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/css/styleguide.min.css" media="all" />
		<link rel="stylesheet" href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/css/prism-typeahead.min.css" media="all" />
	...
	<body id="patternlab-body">
		...
		<header class="sg-header" role="banner">
			<a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#sg-nav-container" class="sg-nav-toggle">Menu</a>
	...
	{{# patternTypeItems }}
		...
		{{# patternSubtypeItems }}
			<li><a href="<?php echo esc_url( home_url( '/styleguide/' ) ) ?>patterns/{{ patternPath }}" class="sg-pop	{{# patternState }}sg-pattern-state {{ patternState }}{{/ patternState }}" data-patternpartial="{{ patternPartial }}">{{ patternName }}</a></li>
		{{/ patternSubtypeItems }}
		</ol></li>
	{{/ patternTypeItems }}
	{{# patternItems }}
...
{{^ ishControlsHide.views-all }}
	<li><a href="<?php echo esc_url( home_url( '/styleguide/' ) ) ?>patterns/" class="sg-pop" data-patternpartial="all">All</a></li>
{{/ ishControlsHide.views-all }}
		</script>
	...
	<ul class="sg-control">
		<li class="sg-size">
			...
			<ul class="sg-size-options">
				{{^ ishControlsHide.s }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-size-s">S</a></li>
				{{/ ishControlsHide.s }}
				{{^ ishControlsHide.m }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-size-m">M</a></li>
				{{/ ishControlsHide.m }}
				{{^ ishControlsHide.l }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-size-l">L</a></li>
				{{/ ishControlsHide.l }}
				{{^ ishControlsHide.full }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-size-full">Full</a></li>
				{{/ ishControlsHide.full }}
				{{^ ishControlsHide.random }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-size-random">Rand</a></li>
				{{/ ishControlsHide.random }}
				{{^ ishControlsHide.disco }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" class="mode-link" id="sg-size-disco">Disco</a></li>
				{{/ ishControlsHide.disco }}
				{{^ ishControlsHide.hay }}
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" class="mode-link" id="sg-size-hay">Hay!</a></li>
				{{/ ishControlsHide.hay }}
			</ul>
		</li>
		{{^ ishControlsHide.tools-all }}
			<li class="sg-tools">
				...
				<ul class="sg-acc-panel sg-right sg-checklist">
					<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" id="sg-t-patterninfo">Show Pattern Info</a></li>
					{{^ ishControlsHide.views-new }}
						<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#" target="_blank" id="sg-raw">Open in new window</a></li>
					{{/ ishControlsHide.views-new }}
					{{^ ishControlsHide.tools-docs }}
						<li><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>http://patternlab.io/docs/" target="_blank">Pattern Lab Docs</a></li>
					{{/ ishControlsHide.tools-docs }}
	...
	<div class="sg-pattern-extra-code">
		...
		<div id="sg-{{ patternPartial }}-tabs" class="sg-tabs">
			<ul class="sg-tabs-list">
				{{# panels }}
					<li id="sg-{{ patternPartial }}-{{ id }}-tab" data-patternpartial="{{ patternPartial }}" data-panelid="{{ id }}"><a href="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>#sg-{{ patternPartial }}-{{ id }}-panel" class="active">{{ name }}</a></li>
				{{/ panels }}
			</ul><!--end .sg-tabs-list-->
	...
	<code id="sg-code-fill-{{ language }}" class="language-{{ language }}">{{{ code }}}</code>
		...
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/data/patternlab-data.js"></script>

		<script>
		<?php $pattern_lab_config = PWCC\Styleguide\get_pl_config_js(); ?>
		var navItems = <?php echo wp_json_encode( $pattern_lab_config['nav_items'] ); ?>;
		var patternPaths = <?php echo wp_json_encode( $pattern_lab_config['pattern_paths'] ); ?>;
		var viewAllPaths = <?php echo wp_json_encode( $pattern_lab_config['view_all_paths'] ); ?>;
		</script>


		
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>annotations/annotations.js"></script>

		<!-- load the external library js -->
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/jquery.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/hogan-3.0.2.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/prism.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/jwerty.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/classList.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/typeahead.bundle.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/EventEmitter.min.js"></script>
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/bower_components/script.min.js"></script>
		...
		<script src="<?php echo esc_url( plugins_url( '/pl/', __FILE__ ) ) ?>styleguide/js/patternlab-viewer.js"></script>

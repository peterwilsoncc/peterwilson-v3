...
function receiveIframeMessage(event) {
  ...
  if ((data.event !== undefined) && (data.event == "patternLab.updatePath")) {
    ...
    if (patternData.patternPartial !== undefined) {
      ...
      path = window.location.protocol+"//"+window.location.host+window.location.pathname.replace("patterns","")+data.path+'?'+Date.now();
      window.location.replace(path);
...
(function (w) {
  ...
  var iFramePath     = baseIframePath+"patterns?"+Date.now();

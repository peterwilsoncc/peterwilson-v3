 ...
 *
 * The styleguide requires WP to be running but does not need real posts,
 * this returns an array of dummy posts to prevent WP_Query from running an
 * SQL Query.
 *
	...
	if ( $query->is_main_query() && isset( $query->query_vars['pattern-library'] ) ) {
		...
		return [
			(object) [
				...
				'post_content_filtered' => 'Lorem ipsum',
				'post_parent'           => 0,
